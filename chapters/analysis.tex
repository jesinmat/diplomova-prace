...
Na základě požadavků na aplikaci bylo vytvořeno konceptuální schéma, které je na obrázku \ref{fig:schema}. Schéma zobrazuje vztahy mezi jednotlivými entitami a jejich atributy.
